...
namespace HRLeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20231017120947_Initial")]
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 10, 17, 9, 9, 47, 641, DateTimeKind.Local).AddTicks(392),
                            DateModified = new DateTime(2023, 10, 17, 9, 9, 47, 641, DateTimeKind.Local).AddTicks(407),
                            Defaultdays = 10,
                            Name = "Vacation"
                        });
                });
